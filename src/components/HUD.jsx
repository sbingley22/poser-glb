...
const HUD = ({ setGizmoMode, setControlsHidden, controlSize, setControlSize }) => {
  ...
  const buttonClass = "p-2 m-1 bg-green-700 hover:bg-green-800"

  return (
    <div
      id="bottom-bar"
      className={`fixed ${
        dockedLeft ? 'left-0 top-0 h-full w-24' : 'bottom-0 left-0 w-full h-12'
    ...
    >
      ...
      <div className={`flex items-center ml-2 ${dockedLeft ? 'flex-col' : 'flex-row'}`}>
